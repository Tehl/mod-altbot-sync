# Character progress sync
- [x] Validate target for sync
- [x] Level up to player level
- [x] Identify missing player quests
- [x] Identify missing class quests
- [x] Complete quests
- [x] Auto-equip upgrades from quest rewards
- [x] Vendor un-needed quest rewards
...
- [ ] Disenchant quest rewards if able
...
- Sync dungeon completion to altbot group
- Roll and allocate loot for synced dungeons